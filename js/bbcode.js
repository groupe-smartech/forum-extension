...
var BBCodeHTML = function() {
    ...
    me.addBBCode('[img={URL} width={NUMBER1} height={NUMBER2}]{TEXT}[/img]', '<img class="img-fluid lazy" src="{URL}" width="{NUMBER1}" height="{NUMBER2}" alt="{TEXT}" />');
    me.addBBCode('[img]{URL}[/img]', '<img class="img-fluid lazy" src="{URL}" alt="{URL}" />');
    me.addBBCode('[img={LINK} width={NUMBER1} height={NUMBER2}]{TEXT}[/img]', '<img class="img-fluid lazy" src="{LINK}" width="{NUMBER1}" height="{NUMBER2}" alt="{TEXT}" />');
    me.addBBCode('[img]{LINK}[/img]', '<img class="img-fluid lazy" src="{LINK}" alt="{LINK}" />');
    ...
    me.addBBCode('[user={LINK}]{TEXT}[/user]', '<a href="https://adoasis.fr/m{LINK}" target="_blank">{TEXT}</a>');
};
